...
public class KeysFactory {
    ...
    private static final String REGISTERED_CONSUMERS_KEY_PATTERN = "mymq.%s.consumers";
    private static final String MESSAGE_KEY_PATTERN = "mymq.%s.messages.%s";
    private static final String QUEUE_PATTERN = "mymq.%s.queues.%s";
    private static final String NEXT_MESSAGE_ID_PATTERN = "mymq.%s.nextID";
